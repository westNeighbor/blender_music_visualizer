...
![](resources/0490.png)
![](resources/Music_visualizer_show.gif)
...
~~The addon relies on the Blender shipped addon `Power Sequencer`; you also need to enable it.~~ New update doesn't rely on it anymore.
